...
class ConveyorTrackingLeadingValues(IEquatable, IEngineeringObject, IEngineeringService, IInternalObjectAccess): # skipped bases: <type 'IInternalInstanceAccess'>, <type 'IEngineeringCompositionOrObject'>, <type 'IEngineeringInstance'>, <type 'IInternalBaseAccess'>, <type 'object'>
    ...
    def ActualValueCoupling(self) -> TechnologicalInstanceDBAssociation:
        ...
        Get: ActualValueCoupling(self: ConveyorTrackingLeadingValues) -> TechnologicalInstanceDBAssociation
        """
        ...

    @property
    def DelayedCoupling(self) -> TechnologicalInstanceDBAssociation:
        """
        Master values that are coupled via actual values

        Get: DelayedCoupling(self: ConveyorTrackingLeadingValues) -> TechnologicalInstanceDBAssociation
        """
        ...
    ...
    def Parent(self) -> IEngineeringObject:
        ...
        Get: Parent(self: ConveyorTrackingLeadingValues) -> IEngineeringObject
        """
        ...
    ...
    def SetPointCoupling(self) -> TechnologicalInstanceDBAssociation:
        ...
        Get: SetPointCoupling(self: ConveyorTrackingLeadingValues) -> TechnologicalInstanceDBAssociation
        """
        ...
    ...
    def GetHashCode(self) -> int:
        """
        GetHashCode(self: ConveyorTrackingLeadingValues) -> int
    ...
    def ToString(self) -> str:
        """
        ToString(self: ConveyorTrackingLeadingValues) -> str
...
class SynchronousAxisMasterValues(IEquatable, IEngineeringObject, IEngineeringService, IInternalObjectAccess): # skipped bases: <type 'IInternalInstanceAccess'>, <type 'IEngineeringCompositionOrObject'>, <type 'IEngineeringInstance'>, <type 'IInternalBaseAccess'>, <type 'object'>
    ...
    def DelayedCoupling(self) -> TechnologicalInstanceDBAssociation:
        ...
        Get: DelayedCoupling(self: SynchronousAxisMasterValues) -> TechnologicalInstanceDBAssociation
        """
        ...
