...
class TechnologicalInstanceDBComposition(IInternalCompositionAccess, IEngineeringComposition, IEquatable): # skipped bases: <type 'IEngineeringInstance'>, <type 'IEnumerable'>, <type 'IInternalBaseAccess'>, <type 'IInternalCollectionAccess'>, <type 'IInternalInstanceAccess'>, <type 'IEngineeringCompositionOrObject'>, <type 'object'>
    ...
    def Import(self, path:FileInfo, importOptions:ImportOptions) -> IList:
        """
        Import(self: TechnologicalInstanceDBComposition, path: FileInfo, importOptions: ImportOptions) -> IList[TechnologicalInstanceDB]

            Simatic ML import of a Technological Object

            path: Path to the Simatic ML file

            importOptions: Options to use for Import

            Returns: System.Collections.Generic.IList<Siemens.Engineering.SW.TechnologicalObjects.TechnologicalInstanceDB>
        """
        ...
