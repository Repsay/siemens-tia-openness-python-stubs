...
class SWImportOptions(Enum): # skipped bases: <type 'IFormattable'>, <type 'IConvertible'>, <type 'IComparable'>, <type 'object'>
    ...
    enum (flags) SWImportOptions, values: IgnoreMissingReferencedObjects (2), IgnoreStructuralChanges (1), IgnoreUnitAttributes (4), None (0)
    """
    IgnoreMissingReferencedObjects: SWImportOptions = ...
    IgnoreStructuralChanges: SWImportOptions = ...
    IgnoreUnitAttributes: SWImportOptions = ...
    value__ = ...
